package cc.dreamcode.rvfaxeventy.command;
...
@Command(name = "event", aliases = "eventy")
@RequiredArgsConstructor(onConstructor_ = @Inject)
public class EventCommand implements CommandBase {

    private final PluginConfig pluginConfig;
    private final MessageConfig messageConfig;

    @Async
    @Permission("rvfaxeventy.reload")
