...
public class MessageConfig extends OkaeriConfig {
        ...
        public BukkitNotice pathNotFound = BukkitNotice
                        .chat("&cTa komenda jest pusta lub nie posiadasz dostepu do niej.");
        ...
        public BukkitNotice notPlayer = BukkitNotice.chat("&cJust for players.");
        public BukkitNotice notPermission = BukkitNotice.chat("&cYou do not have permission to do this.");
        public BukkitNotice invalidUsage = BukkitNotice.chat("&7Usage: &c{usage}");

        public BukkitNotice eventMathStart = BukkitNotice.chat("&aMath Event! Solve: &e{expression}");
        public BukkitNotice eventCodeStart = BukkitNotice.chat("&aCode Event! Type: &e{code}");
        public BukkitNotice eventWinner = BukkitNotice.chat("&aPlayer &e{player} &awon the event! Answer: &e{answer}");
        ...
        public BukkitNotice invalidFormat = BukkitNotice
                        .chat("&cPodano nieprawidlowy format argumentu komendy. ({input})");
